...
// constructors
Client::Client(int fd) : _fd(fd), _nickname(""), _username(""), _realname(""), _passwordAuthenticated(false), _isUserReceived(false) {}
Client::~Client() {}
Client::Client(const Client &other) : _fd(other._fd), _readBuf(other._readBuf), _nickname(other._nickname), _username(other._username), _realname(other._realname), _passwordAuthenticated(other._passwordAuthenticated), _isUserReceived(other._isUserReceived) {}
